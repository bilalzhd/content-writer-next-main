          ...
          <div className="flex flex-col w-full text-gray-700">
            ...
            <div className="flex justify-start pl-4 mt-2">
              <a
                ...
                href="https://www.facebook.com/profile.php?id=61550055025708&mibextid=2JQ9oc"
              >
                <svg
                  viewBox="0 0 24 24"
              ...
              <a
                ...
                href="https://twitter.com/_Content2023"
              >
                <svg
                  viewBox="0 0 24 24"
                  className="w-5 h-5 fill-current"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                href="https://instagram.com/contentwriting0023?utm_source=qr&igshid=MzNlNGNkZWQ4Mg%3D%3D"
              >
